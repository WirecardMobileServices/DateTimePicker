...
public class SimpleMonthAdapter extends RecyclerView.Adapter<SimpleMonthAdapter.MonthViewHolder> {
...
//                || (year == anchor.get(Calendar.YEAR) && year == mSelectedDay.get(Calendar.YEAR) && month >= anchor.get(Calendar.MONTH) && month <= mSelectedDay.get(Calendar.MONTH));
    ...
    public interface OnDaySelectedListener {
        void onDaySelected(SimpleMonthAdapter adapter, Calendar day);
    }
